...
public class StudentService{
    ...
    private HashMap<String, List<Course>> coursesEnrolledByStudents = new HashMap<>(); //Aqui se irán guardando los estudiantes de cada materia 
   ...
   //----------------------------------------------
    public void enrollStudents( String courseName, String studentID )throws StudentNotFoundException,        CourseNotFoundException{
     ...
     if (!courseList.containsKey(courseName)) { //Valida si el nombre del curso existe dentro de nuestra lista de cursos
         ...
         coursesEnrolledByStudents.put( studentID, new ArrayList<>() ); //Si si esta todo, mete al estudiante dentro de la materia a cursar y crea una lista 
     }else {
...
//    for (String studentId : coursesEnrolledByStudents.keySet()) { //foreach que no es foreach, que crea un ciclo dentro de coursesEnrolled que itera sacando los keySet
...
//    		  }//showEnrolledStudents
    ...
    public void showAllCourses(){
    	  System.out.println("Lista de todos los cursos:");
      	  for (Course course : courseList.values()) { //ciclo dentro del courseList que sacara todos los valores (values)
